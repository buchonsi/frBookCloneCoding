...
import com.cloncoding.book.springboot.config.auth.dto.OAuthAttributes;
import com.cloncoding.book.springboot.config.auth.dto.SessionUser;
import com.cloncoding.book.springboot.domain.user.User;
import com.cloncoding.book.springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        // 구글의 경우 기본적으로 코드를 지원하지만, 네이버 카카오 등은 기본 지원을 하지 않는다. 구글의 기본코드는 "sub"이다
